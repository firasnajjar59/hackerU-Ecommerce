...
router
  ...
  ).post(protect,permissionTo('admin', 'contributor'),emailsController.sendEmailToCustemer)
  .patch(
    protect,
    permissionTo('admin', 'contributor'),
    orderController.updatOrderById
  );
